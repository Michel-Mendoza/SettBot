...
module.exports = {
    ...
    msg: async (args, interaction, client) => {
        ...
        let provider_register = {"region": region,"url": "https://discord.com/"}
        ...
        let data = await fetch(api, {headers: {'X-Riot-Token':key}, method: 'POST', body: JSON.stringify(provider_register)})
